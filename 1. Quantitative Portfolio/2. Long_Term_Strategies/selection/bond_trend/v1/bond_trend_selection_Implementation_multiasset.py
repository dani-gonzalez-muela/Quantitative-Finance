...
Outputs: results/bond_trend_multiasset_daily_equity/*.csv
         results/bond_trend_implementations_multiasset.json
"""
import sys, os
...
SUMMARY_PATH = os.path.join(RESULTS_DIR, "bond_trend_multiasset_summary.json")
...
print("="*70); print("BOND TREND — Multi-Asset Implementation"); print("="*70)
...
jp = os.path.join(RESULTS_DIR, "bond_trend_implementations_multiasset.json")
