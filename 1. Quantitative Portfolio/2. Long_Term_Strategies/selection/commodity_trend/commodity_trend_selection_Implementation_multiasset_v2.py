...
# -*- coding: utf-8 -*-
"""Commodity Trend — Implementation v2 (TYPE 2 SELECTION). Uses build_basket_equity."""
import sys, os
...
STRATEGY_NAME="commodity_trend_v2"; STARTING_CAPITAL=100_000
...
SUMMARY_PATH=os.path.join(RESULTS_DIR,"commodity_trend_v2_multiasset_summary.json")
...
print("="*70); print("COMMODITY TREND — Implementation v2  (TYPE 2 SELECTION)"); print("="*70)
...
jp=os.path.join(RESULTS_DIR,"commodity_trend_v2_implementations_multiasset.json")
