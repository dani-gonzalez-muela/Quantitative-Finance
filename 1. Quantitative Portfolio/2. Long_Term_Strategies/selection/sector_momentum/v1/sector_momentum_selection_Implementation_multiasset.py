...
Outputs: results/sector_momentum_multiasset_daily_equity/*.csv
         results/sector_momentum_implementations_multiasset.json
"""
import sys, os
...
SUMMARY_PATH = os.path.join(RESULTS_DIR, "sector_momentum_multiasset_summary.json")
...
print("="*70); print("SECTOR MOMENTUM — Multi-Asset Implementation"); print("="*70)
...
jp = os.path.join(RESULTS_DIR, "sector_momentum_implementations_multiasset.json")
