...
"""
BAB - Betting Against Beta — Implementation (single-instrument stub)
...
SAVE_NAME        = "bab_long_short"
STRATEGY_NAME    = "BAB - Betting Against Beta"
