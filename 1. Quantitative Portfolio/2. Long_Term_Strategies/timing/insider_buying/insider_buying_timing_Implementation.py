...
"""
Insider Buying (VIX Spike Proxy) — Implementation (single-instrument stub)
...
SAVE_NAME        = "insider_buying"
STRATEGY_NAME    = "Insider Buying (VIX Spike Proxy)"
