...
"""
PEAD - Post-Earnings Announcement Drift — Implementation (single-instrument stub)
...
Signal: monthly composite of top-quartile SUE stocks; individual scores not in signal.csv
Instrument: TOP_SUE_Q_portfolio

What this file CAN do:
- Test EXPOSURE LEVEL variants (conservative / baseline / aggressive)
  by loading results/pead_earnings_drift_trades.csv and calling shared.implementations.
- For parameter sweeps (e.g. different VIX thresholds, holding periods),
  modify pead_earnings_drift_Backtest.py and re-run.

To run full sizing comparison, see:
    shared.implementations.simple_bet / vol_targeting / risk_based
    (already applied in pead_earnings_drift_Backtest.py results)
"""
import sys, os
...
SAVE_NAME        = "pead_earnings_drift"
STRATEGY_NAME    = "PEAD - Post-Earnings Announcement Drift"
