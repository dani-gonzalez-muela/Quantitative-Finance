...
"""
REIT Dividend Carry — Implementation (single-instrument stub)
...
SAVE_NAME        = "reit_dividend_carry"
STRATEGY_NAME    = "REIT Dividend Carry"
