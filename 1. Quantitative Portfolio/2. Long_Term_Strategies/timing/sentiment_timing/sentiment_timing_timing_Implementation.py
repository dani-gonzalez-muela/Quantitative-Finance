...
"""
Sentiment Timing (VIX) — Implementation (single-instrument stub)
...
SAVE_NAME        = "sentiment_timing"
STRATEGY_NAME    = "Sentiment Timing (VIX)"
