...
"""
US Earnings Momentum — Implementation (single-instrument stub)
...
SAVE_NAME        = "us_earnings_momentum"
STRATEGY_NAME    = "US Earnings Momentum"
