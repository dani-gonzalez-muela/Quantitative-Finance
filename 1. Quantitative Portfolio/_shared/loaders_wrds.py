"""Re-export of `0. Data/loaders/wrds_data.py` (WRDS/FRED/VIX loaders; gitignored — holds API keys).

Import as:  from _shared.loaders_wrds import load_vix, load_sp500_daily, load_fred_rates
...
_p = _os.path.join(_d, '0. Data', 'loaders', 'wrds_data.py')
...
_spec = _ilu.spec_from_file_location('_loaders_wrds_impl', _p)
